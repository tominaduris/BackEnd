...
import com.portfolio.nt.Dto.dtoEducacion;
import com.portfolio.nt.entity.Educacion;
import com.portfolio.nt.Security.Controller.Mensaje;
import com.portfolio.nt.Service.SEducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        Educacion educacion = new Educacion(dtoeducacion.getNombreE(), dtoeducacion.getDescripcionE(), dtoeducacion.getImagen(),dtoeducacion.getInicio(),dtoeducacion.getFin());
